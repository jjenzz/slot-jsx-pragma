      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col gap-8 items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            ...
            <code className="rounded bg-zinc-100 px-2 py-1 text-sm dark:bg-zinc-800">slot-jsx</code> package,
            demonstrating slottable components with the{' '}
            <code className="rounded bg-zinc-100 px-2 py-1 text-sm dark:bg-zinc-800">asChild</code> pattern in both
