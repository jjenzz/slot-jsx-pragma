...
const Button = React.forwardRef<ButtonRef, ButtonProps>(({ asChild, className, ...props }, forwardedRef) => {
  ...
  return (
    <main className="app">
      <header className="stack">
        ...
        <p className="lede">Use this space to verify the React 17 JSX transform (specifically ref composition).</p>
      </header>
